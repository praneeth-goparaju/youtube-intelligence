...
class TestRemoveOutliers:
    def test_removes_low_subscriber_channels(self):
        videos = [
            {'video': {'calculated': {'viewsPerSubscriber': 2.0}},
             'channel': {'subscriberCount': 500}},  # Below min
            {'video': {'calculated': {'viewsPerSubscriber': 2.0}},
             'channel': {'subscriberCount': 5000}},  # Above min
        ]
    ...
    def test_custom_min_subscribers(self):
        ...
        filtered, stats = remove_outliers(
            videos, get_views_per_subscriber, min_subscribers=100)
