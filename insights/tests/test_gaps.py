...
class TestAnalyzeKeywordGaps:
    ...
    def test_secondary_keywords_included(self):
        videos = []
        for _ in range(5):
            videos.append(make_video(primary_kw="food", secondary_kws=["spicy", "traditional"], vps=5.0))
    ...
    def test_secondary_keywords_as_string(self):
        ...
        videos = []
        for _ in range(5):
            videos.append(make_video(primary_kw="food", secondary_kws="spicy, traditional, homestyle", vps=5.0))
...
class TestAnalyzeFormatGaps:
    def test_basic_format_analysis(self):
        videos = []
        for _ in range(5):
            videos.append(make_video(content_signals={"isRecipe": True, "contentType": "recipe"}, vps=5.0))
        for _ in range(5):
            videos.append(make_video(content_signals={"isTutorial": True, "contentType": "tutorial"}, vps=3.0))
