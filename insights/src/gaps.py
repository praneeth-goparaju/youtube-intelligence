...
class GapAnalyzer:
    ...
    def __init__(self, videos: List[Dict[str, Any]], get_vps: Callable[[Dict], float]):
        """
        Initialize analyzer.
    ...
    def find_content_gaps(self) -> Dict[str, Any]:
        ...
        saturated = [
            ...
            if opp["videoCount"] > total_videos * SATURATION_THRESHOLD and opp["avgViewsPerSubscriber"] < avg_all * 0.8
        ]
