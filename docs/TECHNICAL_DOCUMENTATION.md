...
graph TD
    ...
    subgraph pipeline [DATA PIPELINE]
        B[Phase 1: Scraper<br/>TypeScript] --> C[Phase 2: Analyzer<br/>Python]
        C --> D[Phase 3: Insights<br/>Python]
        D --> E[Phase 4: Recommender<br/>TypeScript]
    end
    B --> F
    C --> F
    D --> F
    ...
    B --> G[Firebase Storage<br/>thumbnails/]
    F --> H[Recommender API]
```
